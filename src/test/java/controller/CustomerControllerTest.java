...
import com.jumia.demo.controller.CustomerController;
...
public class CustomerControllerTest {
	...
	public void setUp() throws Exception{
		this.mockMvc = MockMvcBuilders.standaloneSetup(new CustomerController(CustomerServiceImpl)).build();
    ...
    public void testGetCustomersByCountry() throws Exception {
        ...
        // Mocking service
        when(new CustomerServiceImpl(customerRepository).getAllCustomers(PhoneNoRegex.MOROCCO)).thenReturn(customerDtos);
